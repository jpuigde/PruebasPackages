#Modified by Xavier Illa on Dec 6th 2015.
...
calendarHeat <- function(dates, 
  ...
  #---------------------------------------------------------------------------------------------
  #To change to the european calendar in which weeks start on Monday.
  caldat$dotw<-caldat$dotw-1                                    # Added this two lines to change the weekdays numeration   
  caldat$dotw[caldat$dotw==-1]<-6                               # Monday->0, Sunday->6
  caldat$woty[caldat$dotw==6] <- caldat$woty[caldat$dotw==6]-1  #Sunday to the previous week.
  #---------------------------------------------------------------------------------------------
  ...
  #---------------------------------------------------------------------------------------------
  #Added new color scale
  b2w <- c("#F1EEF6", "#BDC9E1","#74A9CF","#2B8CBE","#045A8D" )   #blue to white 
  #custom <- c("blue","red")   
  custom <- c("#0571B0","#CA0020")
  #custom <- c("darkgray","#007EAE")
